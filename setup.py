...
setup(
    ...
    description          = "ponpontools CTF framework and exploit development library.",
    long_description     = long_description,
    author               = "no1zy",
    author_email         = "bgkn1260128@gn.iwasaki.ac.jp",
    url                  = 'https://github.com/No1zy/ponpontools',
    download_url         = "https://github.com/No1zy/ponpontools",
    install_requires     = install_requires,
    license              = "Mostly MIT, some GPL/BSD, see LICENSE.txt",
    keywords             = 'ponpontools exploit ctf capture the flag binary wargame overflow stack heap defcon',
    classifiers          = [
